...
learningObjectives:
  - Understand hybrid anomaly detection architecture
  - Implement Isolation Forest for statistical outlier detection
  - Configure LSTM Autoencoder for temporal anomalies
  - Tune detection thresholds and contamination parameters
---
